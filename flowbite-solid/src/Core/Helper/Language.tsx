...
interface ToastInterface {
    ...
    makeRtl : () => void,
    makeLtr : () => void,
    subscribe : (id : string,callback : (isRtl : boolean) => void),
}
    ...
    return (
        <ToastContext.Provider value={tmp}>
            <Show when={errorToast().length > 0}>
                <div
                    class="space-x-2 animate-[bounce_1.7s_infinite] fixed z-50 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
                    role="alert">
                    ...
                    <div class="text-sm text-start font-normal">{errorToast()}</div>
                    ...
                    <button type="button"
                        ...
                        <span class="sr-only">{Lang.get('items.close')}</span>
                        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                             xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
